  ...
  return (
    <>
      <div class="bg-zinc-950 h-full">
        <div class="relative isolate w-full h-full pt-1">
          {/* bg shade 1 */}
          <div
            class=" backdrop-blur-sm absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80"
            aria-hidden="true"
          >
            <div
              class="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-sex-900/70 to-cyan-800/70 opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
              style={{
                cliPath:
          ...
          <div class="w-full h-full pt-5 sm:pt-20 lg:pt-6 relative overflow-hidden before:absolute before:top-0 before:start-1/2   before:bg-[url('https://i.postimg.cc/KYQR1Hkb/Hexagon-2.png')]  before:bg-no-repeat before:bg-top before:bg-cover before:size-full before:-z-[1] before:transform before:-translate-x-1/2">
            <div class="px-4 backdrop-blur-sm sm:px-6 lg:px-0 pt-10">
              ...
              <div class="backdrop-blur-sm">
                <div class=" max-w-5xl h-full mx-auto px-4 xl:px-0 pt-16 lg:pt-36 pb-24">
                  <h1 class="font-semibold text-teal-300/80  text-3xl md:text-3xl">
                    ...
                    Resolving Business Complexities Through Advanced IT
                    Solutions
                  </h1>
                  <div class="max-w-4xl">
                    <p class="mt-5  text-neutral-400 text-lg">
                      At <span className="text-teal-300 animate-pulse">NexTechs</span>, we
                      recognize the uniqueness of every business. We prioritize
                      understanding our clients and their specific requirements,
                      allowing us to craft bespoke software solutions that align
                      with their objectives.{" "}
                      <span className="hidden sm:flex">
                        {" "}
                        Our commitment to excellence is reflected in our
                        dedication to delivering top-tier software solutions
                        that drive our clients' success, as their achievements
                        are the true measure of our own.
                      </span>
                    </p>
                  </div>
                  <div className=" pt-6 ">
              ...
              {/* <!-- Clients --> */}
              <div class="relative w-full overflow-hidden pt-4 bg-transparent backdrop-brightness-150 backdrop-blur-sm">
                <svg
                ...
                <div class="relative bg-transparent z-10">
                  <div class="max-w-5xl px-4 xl:px-0 mx-auto">
                    ...
                    <div class="flex justify-between gap-6">
                      <svg
                        class="py-3 lg:py-5 w-16 h-auto md:w-20 lg:w-24 text-neutral-400"
          ...
          >
            <div
              class="relative left-[calc(50%+3rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-cyan-800 to-sex-950 opacity-30 sm:left-[calc(58%+36rem)] sm:w-[65.1875rem]"
              style={{
                cliPath:
                  "polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%),",
              }}
